                ...
                <div class="card card-profile shadow">
                    ...
                    <div class="card-body pt-0 pt-md-4">
                        ...
                        <div class="text-center">
                            ...
                            <div class="h5 mt-4">
                                <i class="ni business_briefcase-24 mr-2"></i>{{ __('Solution Manager - Freelance Officer') }}
                            </div>
                            <div>
                        ...
                        <form method="post" action="{{ route('admin.profile.update') }}" enctype="multipart/form-data">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group">
                                    <label> Image - {{ \App\Models\User::find(Auth::user()->id)->photo->file }}</label>
                                    <input type="hidden" name="phid" value="{{ \App\Models\User::find(Auth::user()->id)->photo->id }}">
